        ...
        value: function bind(notify) {
            ...
            return function () {
                ...
                if (_this._subscription.size === 0) {
                    ...
                    try {
                        for (var _iterator2 = (0, _SafeIterate.copyFrom)(_this._onDown)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
