...
var _DistinctUntilChanged3 = require('./DistinctUntilChanged');
...
var _combineArray = function _combineArray(arr, combineFunc) {
    ...
    var _combine = (0, _Combine.combine)(arrBind, combineFunc),
    ...
    _createClass(Computed, [{
        ...
        */
        ...
        value: function switchMap(swithFunc) {
            ...
            var _switchMap2 = (0, _SwitchMap.switchMap)(function () {
                return _this2.bind();
            }, function (value) {
        ...
        value: function distinctUntilChanged(compare) {
            ...
            var isEqual = compare ? compare : null;

            var _DistinctUntilChanged = (0, _DistinctUntilChanged3.DistinctUntilChanged)(function () {
                return _this3.bind();
            }, isEqual),
                _DistinctUntilChanged2 = _slicedToArray(_DistinctUntilChanged, 2),
                getValueSubscription = _DistinctUntilChanged2[0],
                getResult = _DistinctUntilChanged2[1];

            return new Computed(getValueSubscription, getResult);
        }
    }, {
        key: 'select',
        value: function select(mapFun, compare) {
        ...
        value: function value() {
            var connection = self.bind();
            var value = connection.getValue();

            (0, _renderManager.catchSubscriptionsPush)(connection);
