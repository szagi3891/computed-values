...
var ValueComputed = exports.ValueComputed = function () {
    function ValueComputed(subscription, getValue) {
    ...
    _createClass(ValueComputed, [{
        ...
        value: function map(mapFun) {
            ...
            var subscription = new _ValueSubscription.ValueSubscription(function () {
                if (connection !== null) {
            ...
            return new ValueComputed(subscription, getResult);
        }
    }, {
        key: 'switchMap',
        value: function switchMap(swithFunc) {
            ...
            var subscription = new _ValueSubscription.ValueSubscription(clearConnection);
        ...
        value: function bind(notify) {
            ...
            var disconnect = this._subscription.bind(notify);
        ...
        value: function connect(onRefresh) {
            ...
            var disconnect = this._subscription.bind(function () {
                if (onRefresh) {
